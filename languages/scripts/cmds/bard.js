...
module.exports = {
  ...
  onStart: async function ({ api, args, message, event }) {
    ...
    const cookie = 'bwisO5u6cgT-1fWCsD6lKJo5RzRz26VYtF7j1gblgZqglea5SbzwZU_jXd0iMxwto_P23w.'; //if you don't know know how to get cookie from cookies editor then just don't add the cookie parameter with api params ( it will use my default cookie ) . but i recommend you add your own cookies for less error. 
